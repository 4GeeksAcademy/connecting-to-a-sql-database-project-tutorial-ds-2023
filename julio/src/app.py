...
engine= create_engine(connection_string).execution_options(autocomit=True)
engine.connect()
...
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(1,'Merritt', null,'Eric');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(2,'Linda', null, 'Mui,);
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(3,'Alecos', null, 'Papadatos');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(4,'Anthony', null ,'Molinaro');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(5,'David', null, 'Cronin');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(6,'Richard', null, 'Blum');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(7,'Yuval', 'Noah', 'Harari');
INSERT INTO authors(authors_id, first_name, middle_name, last_name) VALUES(8,'Paul', null ,'Albitz');
