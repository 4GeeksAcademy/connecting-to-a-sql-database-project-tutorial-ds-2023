...
def connect():
    ...
    connection_string = f"postgresql://{username}:{password}@{hostname}/{db_name}"
...
#Had to comment out the previous engine.execute() to run the next step or it would genereate an error. However I belive that the exercise is complete. 
